...
Also run:
5. git status — report any uncommitted changes from previous session
6. git log --oneline -5 — show last 5 commits for context
If uncommitted changes exist — flag them before accepting any new tasks.

Do NOT begin any work until all steps are confirmed.
