        ...
        <div className="rb-12 mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              What BYT handles so you can focus on clinical work
            </h2>
            <p className="md:text-md">
              We manage the business side. You manage the patient care.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:gap-8 lg:grid-cols-4">
            <div className="flex flex-col border border-border-primary sm:col-span-2 sm:row-span-2">
              <div className="flex flex-1 flex-col justify-center p-6 md:p-8 lg:p-12">
                <div>
                  ...
                  <p>
                    Our billing team files all claims. You never touch
                    paperwork.
                  </p>
                </div>
            ...
            <div className="flex flex-col border border-border-primary">
              <div className="flex flex-col justify-center p-6">
                <div>
                  <p className="mb-2 text-sm font-semibold">Referrals</p>
                  <h3 className="mb-2 text-xl font-bold md:text-2xl">
                    Patient referrals and scheduling
                  </h3>
                  <p>
                    Facility-based: wellness directors send referrals.
                    Teletherapy: we source matched patients.
                  </p>
                </div>
